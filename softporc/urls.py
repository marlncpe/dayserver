...
router.register(r'pedidos/insumos', pedidos_insumos_extendidoViewSet)
router.register(r'pedidos', PedidoViewSet)
router.register(r'animales/genetica', animales_geneticaViewSet)
router.register(r'animales', animaleViewSet)
router.register(r'animalesadmin', animales_adminViewSet)
...
router.register(r'salidasplacebo', Salidas_placeboViewSet)
